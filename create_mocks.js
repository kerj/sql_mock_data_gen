  ...
  for (let i = 0; i < length; i++) {
    ...
    for (let key in obj) {
      switch (obj[key]) {
        ...
        case 'FK2':
          // if more than one, use a random value
          mockObj[key] = foreignKeyValues['fk2'][Math.floor(Math.random() * foreignKeyValues['fk2'].length)]
          break;
        case 'FK3':
          // if more than one, use a random value
          mockObj[key] = foreignKeyValues['fk3'][Math.floor(Math.random() * foreignKeyValues['fk3'].length)]
          break;
        default:
          mockObj[key] = obj[key];
          break;
